...
2.2 added DATE_REQUESTED, DATE_ASSIGNED, DATE_PUBLIC, REQUESTER, ASSIGNER, REPLACED_BY,  STATE, TITLE  to root so we can generate CSV entries from the JSON artifact
